...
# SUNCG train
# path = os.path.join('/home/jason/lscCcode/selectImageFromRawSUNCG/selectedImage', 'image_list_train.txt')
# outputpath = '/media/jason/新加卷/suncg_selected'
# hardpath = os.path.join(outputpath, 'hard_examples.npy')

# SUNCG test
path = os.path.join('/home/jason/lscCcode/selectImageFromRawSUNCG/selectedImage', 'image_list_val.txt')
outputpath = '/media/jason/新加卷/suncg_selected_val'
# hardpath = os.path.join(outputpath, 'hard_examples.npy')
