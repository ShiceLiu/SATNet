...
# data_dir = ['/home/jason/lscCcode/selectImageFromRawSUNCG/selectedImage/image_list_train.txt']
# outputpath = '/home/jason/lscPythoncode/pre-get_training_data/myselect_suncg'

data_dir = ['/home/jason/lscCcode/selectImageFromRawSUNCG/selectedImage/image_list_val.txt']
outputpath = '/home/jason/lscPythoncode/pre-get_training_data/myselect_suncg_val'

depthlist = []
binlist = []

for i in xrange(len(data_dir)):
    list_file = data_dir[i]
    fid = open(list_file, "r")
    for line in fid.readlines():
        line = line.rstrip("\n")
        for file in os.listdir(line[0:58] + 'depthVox'):
            if line[65:72] in file and '.png' in file:
                line1 = line[0:58] + 'depthVox/' + file
            if line[65:72] in file and '.bin' in file:
                line2 = line[0:58] + 'depthVox/' + file
        if os.path.exists(line1) and os.path.exists(line2):
            depthlist.append(line1)
            binlist.append(line2)
            line1 = ''
            line2 = ''
