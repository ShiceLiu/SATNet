...
outputpath = '/media/jason/新加卷/shurans_selected'
...
for index in xrange(lenlist):
    ...
    depth = cv2.imread(depthlist[index], -1)
    ...
    np.savez_compressed(os.path.join(outputpath,'%06d.npz'%fileindex), tsdf.numpy(),
